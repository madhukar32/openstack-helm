...
{{ include "glance.conf.glance_registry_values_skeleton" .Values.conf.glance | trunc 0 }}
{{ include "glance.conf.glance_registry" .Values.conf.glance }}
...
#  (string value)
# from .profiler.glance.registry.es_doc_type
{{ if not .profiler.glance.registry.es_doc_type }}#{{ end }}es_doc_type = {{ .profiler.glance.registry.es_doc_type | default "notification" }}
...
#  (string value)
# from .profiler.glance.registry.es_scroll_time
{{ if not .profiler.glance.registry.es_scroll_time }}#{{ end }}es_scroll_time = {{ .profiler.glance.registry.es_scroll_time | default "2m" }}

#
# Elasticsearch splits large requests in batches. This parameter defines
# maximum size of each batch (for example: es_scroll_size=10000).
#  (integer value)
# from .profiler.glance.registry.es_scroll_size
{{ if not .profiler.glance.registry.es_scroll_size }}#{{ end }}es_scroll_size = {{ .profiler.glance.registry.es_scroll_size | default "10000" }}

#
# Redissentinel provides a timeout option on the connections.
# This parameter defines that timeout (for example: socket_timeout=0.1).
#  (floating point value)
# from .profiler.glance.registry.socket_timeout
{{ if not .profiler.glance.registry.socket_timeout }}#{{ end }}socket_timeout = {{ .profiler.glance.registry.socket_timeout | default "0.1" }}
...
#  (string value)
# from .profiler.glance.registry.sentinel_service_name
{{ if not .profiler.glance.registry.sentinel_service_name }}#{{ end }}sentinel_service_name = {{ .profiler.glance.registry.sentinel_service_name | default "mymaster" }}
